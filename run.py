...
# Энкодеры аналогичны тем, что использовались при обучении модели
latent_dim = 256
english_texts=[]
french_texts=[]
english_character=[]
...
# Функция декодирования 0 и 1 обратно в текст
...
tst_a = translate("Good evening!")
tst_b = translate("What is your name?")
print("Good evening!", tst_a)
print("What is your name?", tst_b)
